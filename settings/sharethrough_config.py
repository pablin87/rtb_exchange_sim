...
conf = {
        ...
        'req_body_templates' : [ 
                                'plugin/sharethrough/native_req_app_wall.tmpl', 
                                'plugin/sharethrough/native_req_chat_list.tmpl',
                                'plugin/sharethrough/native_req_content_stream_video.tmpl',
                                'plugin/sharethrough/native_req_google_text_ad.tmpl'
                                ],
